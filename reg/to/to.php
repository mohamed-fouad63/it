    ...
    <div class="container">
        <form method="post">
            ...
            <div class="form-group row">
                ...
                <div class="dis-grid">
                    <span id="hp506" class="mos1" onclick="getid1(this)">رد على المسجل RKEG بطلب و تم ارسال الطلب للمخزن المحلى بالمسجل RKEG بتاريخ</span>
                    <span id="hp506" class="mos1" onclick="getid1(this)">100 طلب تعديل جهه صرف + 100 طلب فتح حساب معاش</span>
                </div>
            </div>
            <div class="form-group row">
