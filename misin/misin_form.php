...
document.getElementById('misin_type_label').style.color = "white";
...
document.getElementById('misin_type_label').style.color = "black";
...
<div class="col-sm-4">
<input type="date" class="form-control list"  id="misin_date"   name="misin_date" placeholder="تاريخ الماموريه" required>
</div>
...
<label class="panel-title">هل تم تنزيل برامج الخدمات و البرامج المساعده و مكافح الفيروسات </label>
</div>
...
<div class="panel panel-default dvice_mode">
<div class="panel-heading">
<label class="panel-title">هل نظام التشغيل النسخه المعتمده من قطاع الدم الفنى </label>
</div>
<div class="panel-body">
...
<div class="panel panel-default dvice_mode">
<div class="panel-heading">
<label class="panel-title" for="des"> ادفتر الاستثمار</label>
</div>
<label for="des">
<div class="panel-body">
...
<fieldset id="does"><legend ><span class="badge"> ما تم عمله </span></legend>
<div class="form-group"  >
