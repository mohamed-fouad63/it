...
<form method="POST" class="form-horizontal export_other_form">
<div class="modal-dialog modal-lg">
<!-- Modal content-->
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title">اعاده للمكتب الاصلى </h4>
...
<div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="other_export_date"  name="_export_date" placeholder="other_export_date" required value="<?php echo date('Y-m-d'); ?>">
</div>
...
<button type="submit" class="btn btn-primary"  data-dismiss="modal" id="export_other" onclick="get_export_id(this);"><i class="fas fa-check"></i>ارسال</button>
<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fas fa-ban"></i> الغاء</button>
</div>
</div>
</div>
<div style="display:none">
<input style="" type="text" name="_export_num" id="other_export_num" placeholder="other_export_num" required readonly>
<input style="" type="text" name="_post_office" id="other_post_office" placeholder="other_post_office" required readonly>
<input style="" type="text" name="_from_post_office" id="other_from_post_office" placeholder="other_from_post_office" required readonly>
</div>
</form>  
</div>