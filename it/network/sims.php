...
<button type='button' class='btn  btn-outline-secondary' data-toggle='modal' data-placement="right" title="اضافه  الجهاز" data-target='#add_sim'><i class='fas fa-plus'></i></button><?php }?>
