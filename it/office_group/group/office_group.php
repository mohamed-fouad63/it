...
<button type="button" class="btn btn-default" data-dismiss="modal">الغاء</button>
    ...
    $qyery_to_add = mysqli_query($conn, "SELECT post_group,COUNT(post_group) FROM all1 WHERE post_group LIKE '$office_group_name'  HAVING COUNT(*) >= 1");
if (mysqli_num_rows($qyery_to_add) >= 1){ echo "<script> alert ('مكرر')</script>"; }
    else {
        $add_office_group = "INSERT INTO all1 (post_group) VALUES ('$office_group_name')";
