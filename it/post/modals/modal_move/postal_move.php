...
<form method="POST" class="form-horizontal move_postal_form" role="form">
...
<input style="display:none" type="text" name="_move_num" id="postal_move_num" placeholder="postal_move_num" required readonly >
...
<label class="control-label col-sm-2" >من</label>
  ...
  <div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="postal_move_date"  name="_move_date" placeholder="postal_move_date" required value="<?php echo date('Y-m-d'); ?>">
</div>
