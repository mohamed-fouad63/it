...
<input type="hidden" name="_export_num" id="postal_export_num" placeholder="postal_export_num"  >
<input type="hidden" name="_export_count_in_it" id="postal_export_count_in_it" placeholder="postal_export_count_in_it"  >
...
<div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="postal_export_date"  name="_export_date" value="<?php echo date('Y-m-d'); ?>" required>
</div>
