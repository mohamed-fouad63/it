...
$query_pc_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'pc'");
$query_monitor_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'MONITOR'");
$query_printer_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'PRINTER'");
$query_pos_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'pos'");
$query_network_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'NETWORK'");
$query_postal_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'postal'");
$query_other_in_tts=mysqli_query($conn, "select * from in_it where status like '{$key}' && id like 'other'");
