function move_pc() {
  ...
  for (var i = 1; i < table.rows.length; i++) {
    table.rows[i].onclick = function () {
      ...
      document.getElementById("pc_move_from").value =
        document.getElementById("post_office_name").innerHTML;
...
function move_monitor() {
  var table1 = document.getElementById("monitor_table"),
    rIndex1;
  office_name = document.getElementById("post_office_name").innerHTML;
