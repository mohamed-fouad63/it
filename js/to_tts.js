...
document.getElementById("pc_count_in_tts").value = this.cells[8].innerHTML;
...
rIndex = this.rowIndex;
//   console.log(rIndex);
document.getElementById("monitor_name_tts").value = this.cells[1].innerHTML;
document.getElementById("monitor_sn_tts").value = this.cells[2].innerHTML;

document.getElementById("monitor_count_in_tts").value = this.cells[8].innerHTML;
document.getElementById("monitor_num_tts").value = this.cells[9].innerHTML;
};}}
...
rIndex = this.rowIndex;
//   console.log(rIndex);
document.getElementById("printer_name_tts").value = this.cells[1].innerHTML;
document.getElementById("printer_sn_tts").value = this.cells[2].innerHTML;

document.getElementById("printer_count_in_tts").value = this.cells[8].innerHTML;
document.getElementById("printer_num_tts").value = this.cells[9].innerHTML;
};}}
function pos_to_tts() {
...
document.getElementById("pos_count_in_tts").value = this.cells[8].innerHTML;
...
rIndex = this.rowIndex;
//   console.log(rIndex);
document.getElementById("network_name_tts").value = this.cells[1].innerHTML;
document.getElementById("network_sn_tts").value = this.cells[2].innerHTML;

document.getElementById("network_count_in_tts").value = this.cells[8].innerHTML;
document.getElementById("network_num_tts").value = this.cells[9].innerHTML;
};}}
...
rIndex = this.rowIndex;
//   console.log(rIndex);
document.getElementById("postal_name_tts").value = this.cells[1].innerHTML;
document.getElementById("postal_sn_tts").value = this.cells[2].innerHTML;

document.getElementById("postal_count_in_tts").value = this.cells[8].innerHTML;
...
document.getElementById("other_count_in_tts").value = this.cells[8].innerHTML;
