...
<form method="POST" class="form-horizontal move_printer_form" role="form">
...
<input style="display:none" type="text" name="_move_num" id="printer_move_num" placeholder="printer_move_num" required readonly >
...
<label class="control-label col-sm-2" >من</label>
  ...
  <div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="printer_move_date"  name="_move_date" placeholder="printer_move_date" required value="<?php echo date('Y-m-d'); ?>">
</div>
