...
<form  class="form-horizontal move_pc_form" role="form">
...
<input style="display:none" type="hidden" name="_move_num" id="pc_move_num"  placeholder="pc_move_num" required readonly >
<input style="display:none" type="hidden" name="_id1" id="pcid"  placeholder="pc_move_post_group" required readonly >
...
<label class="control-label col-sm-2" >من</label>
  ...
  <div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" name="_move_date" placeholder="pc_move_date" required value="<?php echo date('Y-m-d'); ?>">
</div>
...
<div class="col-sm-4">
<input type="text" class="form-control" name="_move_note" placeholder="pc_move_note"> 
</div>
