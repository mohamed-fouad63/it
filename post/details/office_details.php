...
?>
                ...
                <th><?php if ( $_SESSION['add_dvice'] == "1"){ ?>
                    <button type='button' class='btn  btn-outline-secondary' data-toggle='modal' data-placement="right" title="اضافه  الجهاز" data-target='#add_dvice' onclick='add_dvice()'><i class='fas fa-plus'></i></button><?php }?></th>
            </tr>
            <tr>
                <th>الكود المالى</th>
                <th>الكود البريدى</th>
