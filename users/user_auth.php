...
<body style="margin-top: 58px;">
    <div class="">
        ...
        <div class="">
            <div style="direction:rtl;" class="" id="">
...
while($row_pc=mysqli_fetch_assoc($result)){
 ...
 ?>
                    ...
                    <tr>
                        ...
                        <td><button type="submit" class=" btn btn-outline-secondary btn-edit" name="updat_auth">
                                <i class=""></i>تحديث</button></td>
                        </form>
                        </ul>
                        </td>
                    </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" id="user_id" name="user_id" placeholder="user_id">
                            </div>
                            <label class="control-label col-sm-2" style="text-align:center;"> رقم الملف</label>
                        </div>
                        <div class="input-group">
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="job" name="job" placeholder="IP">
                            </div>
    ...
    <!-- end add dvice -->
    <?php // if(isset($_POST['misin_form_sub'])){require 'misin_form_sub.php';} ?>
    <!-- end misin form -->
...
<script>
    ...
    $(document).on('blur', '.id_card', function() {
        var table = document.getElementById("tbl_user"),
            rIndex;
        ...
        for (var i = 1; i < table.rows.length; i++) {
            table.rows[i].onclick = function() {
                ...
                var id = $("#user_id").text();
                var id_card = $(this).text();
                alert(id);
                edit_data(id, id_card, "id_card");
            }
        }
    });
