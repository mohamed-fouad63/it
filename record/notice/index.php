...
<button type="button" class="btn btn-primary edit_notice_submit" id="edit_notice_submit"  name="notice_edit"><i class="fas fa-check"></i> تعديل</button>
...
<!--Logout Modal -->
  ...
  <script>
    $(document).ready(function()
    {
      ...
      <!-- strat function to edit -->
        function edit_data(id, text, column_name)  //(id for update by it, the text that edited , the colum name that updated)
        {   
            $.ajax({  
                url:"edit.php",  
                method:"POST",  
        ...
        <!-- end function to edit -->
        <!-- start edit fisrt name text in first name colume-->
  /* $(document).on('click', '.edit_notice_submit', function(){ 
    
 var m = $('#notice_type').val();
  alert(m);

       // var id = $(this).data("id1");  
       // var first_name = $(this).text();  
        //edit_data(id, first_name, "notice_noti");  
    });*/
        <!-- end edit fisrt name text in first name colume-->
    });
  </script>
</html>
