...
<thead>
<tr>
    <th caption="تاريخ الورود" class="th_date_in  "></th>
    <th caption="عن طريق" class="th_by  "></th>
    <th caption="اسم المكتب" class="th_office"></th>
    <th caption="نوع الجهاز" class="th_dvice  "></th>
    <th caption="السريال" class="th_sn  "></th>
    <th caption="العطل" class="th_damage  "></th>
    <th caption="ملاحظات" class="th_note  "></th>
