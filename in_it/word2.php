<?php
if(isset($_POST['sub_print_ticket'])){
    $pc_name_ticket = strtoupper($_POST['pc_name_ticket']);
    $pc_sn_ticket = $_POST['pc_sn_ticket'];
    $pc_damage_ticket = $_POST['pc_damage_ticket'];
...
<body class="A4 landscape">
    <div class="sheet padding-5mm">
        <div class="flex">
            ...
            <div><img class="post_logo" src="post.png" alt=""></div>
        </div>
        <hr>
        <div class="flex margin_top">
            ...
            <div><img class="post_logo" src="khtm.png" alt=""></div>
            <div>
        ...
        <div class="flex margin_top">
            ...
            <div><img src="hktm_cairo.png" alt=""></div>
        </div>
    </div>
</body>
