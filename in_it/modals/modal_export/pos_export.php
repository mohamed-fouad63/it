...
<input type="hidden" name="_export_num" id="pos_export_num" placeholder="pos_export_num"  >
<input type="hidden" name="_export_count_in_it" id="pos_export_count_in_it" placeholder="pos_export_count_in_it"  >
...
<label class="control-label col-sm-2" >الرقم التسلسلى</label>
  ...
  <div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="pos_export_date"  name="_export_date" value="<?php echo date('Y-m-d'); ?>" required >
</div>
