...
<input type="hidden" name="_export_num" id="other_export_num" placeholder="other_export_num"  >
<input type="hidden" name="_export_count_in_it" id="other_export_count_in_it" placeholder="other_export_count_in_it"  >
...
<div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="other_export_date"  name="_export_date" value="<?php echo date('Y-m-d'); ?>" required>
</div>
