...
<form method="POST" class="form-horizontal move_network_form">
<div class="modal-dialog modal-lg">

<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title">نقل جهاز شبكه</h4>
<button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
<div class="modal-body">
<input  type="hidden" name="_move_num" id="network_move_num" placeholder="network_move_num" required readonly >
<input  type="hidden" name="_move_num_in_it" id="network_move_num_in_it" placeholder="network_move_num_in_it" required readonly >
...
<div class="input-group">
<div class="col-sm-4">
<input type="date" class="form-control" id="network_move_date"  name="_move_date" value="<?php echo date('Y-m-d'); ?>" placeholder="network_move_date" required style="width: 100%;">
</div>
