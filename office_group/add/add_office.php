...
$query_id_hg = mysqli_query($conn, "SELECT * FROM tbl_user where job like 'hg' ");
?>
<!DOCTYPE html>
<html>
                ...
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-4">
                        <div class="input-group-prepend">
                            ...
                            <option value="<?php echo $row_query_post_group["post_group"];?>"><?php echo $row_query_post_group["post_group"];?></option>
                            <?php } ?>
                        </select>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-4">
                        ...
                        <?php
                $query_iname_it = mysqli_query($conn, "SELECT first_name FROM tbl_user where job like 'رئيس مجموعه' ");
                                    ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="sat" class="form-control details-text" >
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="3G" class="form-control details-text">
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="LL" class="form-control details-text">
                    </div>
                </div>
            </div>
            <div class="row">
