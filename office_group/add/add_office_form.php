...
(id_it,id_hg,office_name,post_group,money_code,post_code,postal_code,g_postal,tel,sat,address,3G,LL,Stamps,domain_name) VALUES ('$id_it','$id_hg','$office_name','$post_group','$money_code','$post_code','$postal_code','$g_postal','$tel','$sat','$address','$g3','$LL','$stamps','$domain_name')";
